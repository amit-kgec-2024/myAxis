...
const SellerEdit = () => {
  ...
  const fetchSellerData = async (sellerId) => {
    try {
      const response = await fetch(
        environment.apiUrl + `seller/view/${sellerId}`
      );
      if (!response.ok) {
  ...
  const deletContact = async (index, id) => {
    ...
    try {
      const response = await fetch(
        environment.apiUrl + `seller/delete/contact/${id}`,
        {
          method: "DELETE",
          headers: {
      ...
      if (response.ok) {
        ...
        fetchSellerData(sellerId);
        toast.success("Seller Contact Details Deleted Successfully");
      } else {
  ...
  const removeBankDetail = async (index, id) => {
    ...
    try {
      const response = await fetch(
        environment.apiUrl + `seller/delete/bank/${id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        fetchSellerData(sellerId);
        toast.success("Seller bank Details Deleted Successfully");
      } else {
  ...
  const handelSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        environment.apiUrl + `seller/update/${sellerId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      await response.json();
      toast.success("Seller Add SuccesFully");
      navigate("/seller-list");
    } catch (error) {
      console.log(error);
